...
use App\Repository\DomisiliRepository;

class DomisiliController extends Controller
{
    protected $repo;

    public function __construct(DomisiliRepository $repo)
    {
        $this->repo = $repo;
    }
    ...
    public function index()
    {
        ...
        return view('pages.surat.keterangan_domisili.index', compact('config', 'nomorSurat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json([
                'success' => true,
                'message' => 'Surat Keterangan Domisili berhasil disimpan ke arsip',
    ...
    // Redirect ke arsip terpadu, filter Domisili
    public function arsip()
    {
        return redirect()->route('surat.arsip', ['jenis' => 'DOMISILI']);
    }
}