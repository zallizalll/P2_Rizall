...
<div class="aw-page-header mb-4">
    <div class="aw-header-left">
        <div class="aw-header-icon" style="background: linear-gradient(135deg, #8b5cf6, #6d28d9);">
            <i class="bx bx-shield"></i>
        </div>
        <div>
            <h4 class="aw-title">Surat Keterangan Tidak Mampu
                <span class="aw-title-sub">SKTM</span>
            </h4>
    ...
    <div class="col-xl-5 col-lg-5">
        <div class="aw-card">
            ...
            <div class="aw-section">
                ...
                <div class="aw-hint"><i class="bx bx-info-circle me-1"></i>Format: 474/XXX/SKTM/BULAN/TAHUN</div>
            </div>
            ...
            <div class="aw-section">
                ...
                <div class="row g-2">
                    <div class="col-12">
                        <label class="aw-label">Keperluan <span class="text-danger">*</span></label>
        ...
        <div class="aw-preview-card">
            ...
            <div class="aw-preview-body">
                ...
                <div id="surat-preview" style="
                    ...
                    <div style="margin:16px 0;">
                        <p style="margin:4px 0; text-align:justify;">
                            Adalah benar warga <b>{{ $config->name ?? 'Kelurahan' }}</b>
