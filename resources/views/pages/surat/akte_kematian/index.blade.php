...
<div class="aw-page-header mb-4">
    <div class="aw-header-left">
        <div class="aw-header-icon" style="background: linear-gradient(135deg, #ef4444, #b91c1c);">
            <i class="bx bx-file-blank"></i>
        </div>
        <div>
            <h4 class="aw-title">Surat Keterangan Kematian</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.admin') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="#">Surat</a></li>
                    <li class="breadcrumb-item active">Akte Kematian</li>
                </ol>
            </nav>
        </div>
    </div>
...
{{-- WARNING --}}
<div class="aw-alert-warning mb-4">
    ...
    <div class="col-xl-5 col-lg-5">
        <div class="aw-card">
            ...
            <div class="aw-section">
                ...
                <div class="aw-hint"><i class="bx bx-info-circle me-1"></i>Format: 474/XXX/AK/BULAN/TAHUN</div>
            </div>
            ...
            <div class="aw-section">
                ...
                <div class="aw-hint mb-3"><i class="bx bx-error-circle me-1 text-danger"></i>Hanya menampilkan warga dengan status <b>hidup</b></div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="aw-input" id="nama" placeholder="Nama lengkap">
                    </div>
                    <div class="col-7">
                    ...
                    <div class="col-6">
                        <label class="aw-label">Umur</label>
                        <input type="text" class="aw-input aw-readonly" id="umur" placeholder="-" readonly>
                    </div>
                    <div class="col-6">
            ...
            <div class="aw-section">
                ...
                <div class="row g-2">
                    <div class="col-12">
                        <label class="aw-label">Tanggal Meninggal <span class="text-danger">*</span></label>
                        <input type="text" class="aw-input" id="tanggal_meninggal" placeholder="contoh: 15 Februari 2026">
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Tempat Meninggal <span class="text-danger">*</span></label>
                        <input type="text" class="aw-input" id="tempat_meninggal" placeholder="contoh: RS Hasan Sadikin Bandung">
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Sebab Meninggal <span class="text-danger">*</span></label>
                        <select class="aw-input aw-select" id="sebab_select">
                        ...
                        <input type="text" class="aw-input mt-2 d-none" id="sebab_manual" placeholder="Ketik sebab meninggal...">
                    </div>
                </div>
            </div>
            ...
            <div class="aw-section">
                <div class="aw-section-label">
                    <span class="aw-step aw-step-green">4</span>
                    <span>Data Pelapor</span>
                </div>

                <div class="aw-search-wrap mb-2">
                    <div class="aw-search-icon"><i class="bx bx-search"></i></div>
                    <input type="text" class="aw-input aw-search-input" id="searchPelapor"
                        placeholder="Cari NIK atau nama pelapor..." autocomplete="off">
                    <div id="searchResultsPelapor" class="aw-dropdown"></div>
                </div>
                <div class="aw-hint mb-3"><i class="bx bx-info-circle me-1"></i>Data diambil dari data warga</div>

                <div class="row g-2">
                    <div class="col-12">
                        <label class="aw-label">Nama Pelapor</label>
                        <input type="text" class="aw-input aw-readonly" id="nama_pelapor" placeholder="Terisi otomatis" readonly>
                    </div>
                    <div class="col-12">
                        <label class="aw-label">NIK Pelapor</label>
                        <input type="text" class="aw-input aw-readonly" id="nik_pelapor" placeholder="Terisi otomatis" readonly>
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Hubungan dengan Almarhum <span class="text-danger">*</span></label>
                        <select class="aw-input aw-select" id="hubungan_pelapor">
            ...
            <div class="aw-section">
                <div class="aw-section-label">
                    <span class="aw-step" style="background:#6366f1;">5</span>
            ...
            <div class="aw-actions">
                <button type="button" class="aw-btn-danger flex-fill" id="btnSimpan">
                    <i class="bx bx-save"></i> Simpan &amp; Ubah Status
                </button>
                <button type="button" class="aw-btn-success flex-fill" onclick="window.print()">
                    <i class="bx bx-printer"></i> Cetak PDF
                </button>
                <button type="button" class="aw-btn-icon-secondary" id="btnReset" title="Reset Form">
            ...
            <div class="aw-preview-body">
                ...
                <div id="surat-preview" style="
                    ...
                    <p style="margin:0 0 14px 0; text-align:justify;">
                        ...
                        menerangkan bahwa telah meninggal dunia seseorang dengan keterangan sebagai berikut:
                    </p>
                    ...
                    <table style="width:100%; border-collapse:collapse; margin:4px 0 16px 0;">
                        ...
                        <tr>
                            <td style="padding:2px 0;">Umur</td>
                            <td>:</td>
                            <td><span id="p-umur">-</span> tahun</td>
                        </tr>
                        <tr>
                    ...
                    <table style="width:100%; border-collapse:collapse; margin:4px 0 16px 0;">
                        <tr>
                            <td style="width:37%; padding:2px 0;">Tanggal Meninggal</td>
                            <td style="width:3%;">:</td>
                            <td><span id="p-tanggal-meninggal">-</span></td>
                        </tr>
                        <tr>
                            <td style="padding:2px 0;">Tempat Meninggal</td>
                            <td>:</td>
                            <td><span id="p-tempat-meninggal">-</span></td>
                        </tr>
                        <tr>
                            <td style="padding:2px 0;">Sebab Meninggal</td>
                            <td>:</td>
                            <td><span id="p-sebab-meninggal">-</span></td>
                        </tr>
                    </table>
                    ...
                    <table style="width:100%; border-collapse:collapse; margin:4px 0 16px 0;">
                        <tr>
                            <td style="width:37%; padding:2px 0;">Nama Pelapor</td>
                            <td style="width:3%;">:</td>
                            <td><span id="p-nama-pelapor">-</span></td>
                        </tr>
                        <tr>
                            <td style="padding:2px 0;">Hubungan dengan Almarhum</td>
                            <td>:</td>
                            <td><span id="p-hubungan-pelapor">-</span></td>
                        </tr>
                    </table>
...
<style>
    /* =============================================
   AW - SHARED STYLES (sama dengan Ahli Waris)
   ============================================= */
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('tanggal_meninggal').addEventListener('input', function() {
            setP('p-tanggal-meninggal', this.value);
        });
        document.getElementById('tempat_meninggal').addEventListener('input', function() {
            setP('p-tempat-meninggal', this.value);
        });
        document.getElementById('sebab_select').addEventListener('change', function() {
            ...
            if (this.value === 'lainnya') {
                ...
                setP('p-sebab-meninggal', this.value);
            }
        });
        document.getElementById('sebab_manual').addEventListener('input', function() {
            setP('p-sebab-meninggal', this.value);
        });
        document.getElementById('hubungan_pelapor').addEventListener('change', function() {
            setP('p-hubungan-pelapor', this.value);
        });
        ...
        document.getElementById('btnSimpan').addEventListener('click', async function() {
            ...
            const tanggalMeninggal = document.getElementById('tanggal_meninggal').value;
            const tempatMeninggal = document.getElementById('tempat_meninggal').value;
            const namaPelapor = document.getElementById('nama_pelapor').value;
            const hubunganPelapor = document.getElementById('hubungan_pelapor').value;

            if (!tanggalMeninggal || !tempatMeninggal || !sebabVal) {
                alert('Lengkapi data kematian: tanggal, tempat, dan sebab meninggal.');
                return;
            }
            if (!namaPelapor || !hubunganPelapor) {
                alert('Lengkapi data pelapor: nama dan hubungan dengan almarhum.');
                return;
            }
            if (!confirm(`⚠️ Perhatian!\n\nSetelah disimpan, status warga:\n"${nama}"\nakan otomatis berubah menjadi MENINGGAL.\n\nLanjutkan?`)) return;
