...
<div class="aw-page-header mb-4">
    <div class="aw-header-left">
        <div class="aw-header-icon" style="background: linear-gradient(135deg, #f59e0b, #b45309);">
            <i class="bx bx-transfer"></i>
        </div>
        <div>
            <h4 class="aw-title">Surat Keterangan Pindah Keluar</h4>
    ...
    <a href="{{ route('arsip.index', ['jenis' => 'PINDAH_KELUAR']) }}" class="btn aw-btn-arsip">
    ...
    <div class="col-xl-5 col-lg-5">
        <div class="aw-card">
            ...
            <div class="aw-section">
                ...
                <div class="aw-hint"><i class="bx bx-info-circle me-1"></i>Format: 474/XXX/PK/BULAN/TAHUN</div>
            </div>
            ...
            <div class="aw-section">
                ...
                <div class="aw-hint mb-3"><i class="bx bx-error-circle me-1 text-danger"></i>Hanya menampilkan warga berstatus <b>hidup</b></div>

                <div class="row g-2">
                    <div class="col-12">
                        <label class="aw-label">NIK</label>
                        <input type="text" class="aw-input aw-readonly" id="nik" placeholder="Terisi otomatis" readonly>
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Nama Lengkap</label>
                        <input type="text" class="aw-input aw-readonly" id="nama" placeholder="Terisi otomatis" readonly>
                    </div>
                    <div class="col-7">
                    ...
                    <div class="col-6">
                        <label class="aw-label">Status Nikah</label>
                    ...
                    <div class="col-12">
                        <label class="aw-label">Alamat Asal</label>
                        <textarea class="aw-input aw-readonly" id="alamat_asal" rows="2" readonly></textarea>
                    </div>
                    <div class="col-6">
            ...
            <div class="aw-section">
                <div class="aw-section-label">
                    ...
                    <span>Tujuan Kepindahan</span>
                </div>

                <div class="row g-2">
                    <div class="col-12">
                        <label class="aw-label">Alamat Tujuan <span class="text-danger">*</span></label>
                        <textarea class="aw-input" id="alamat_tujuan" rows="2" placeholder="Jl. Contoh No. 1 RT 002/003"></textarea>
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Kelurahan Tujuan</label>
                        <input type="text" class="aw-input" id="kelurahan_tujuan" placeholder="contoh: Kelurahan Sukajadi">
                    </div>
                    <div class="col-6">
                        <label class="aw-label">Kecamatan</label>
                        <input type="text" class="aw-input" id="kecamatan_tujuan" placeholder="contoh: Sukajadi">
                    </div>
                    <div class="col-6">
                        <label class="aw-label">Kota</label>
                        <input type="text" class="aw-input" id="kota_tujuan" placeholder="contoh: Kota Bandung">
                    </div>
                    <div class="col-12">
                        <label class="aw-label">Alasan Pindah <span class="text-danger">*</span></label>
                        <select class="aw-input aw-select" id="alasan_select">
                        ...
                        <input type="text" class="aw-input mt-2 d-none" id="alasan_manual" placeholder="Ketik alasan pindah...">
                    </div>
                </div>
            </div>
            ...
            <div class="aw-actions">
                <button type="button" class="aw-btn-warning flex-fill" id="btnSimpan">
        ...
        <div class="aw-preview-card">
            ...
            <div class="aw-preview-body">
                ...
                <div id="surat-preview" style="
                    ...
                    {{-- DATA WARGA --}}
                    <div style="margin-bottom:6px; font-weight:bold; font-size:10pt; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #ccc; padding-bottom:4px;">Data Penduduk</div>
                    ...
                    {{-- DATA TUJUAN --}}
                    <div style="margin-bottom:6px; font-weight:bold; font-size:10pt; text-transform:uppercase; letter-spacing:0.5px; border-bottom:1px solid #ccc; padding-bottom:4px;">Tujuan Kepindahan</div>
                    <table style="width:100%; border-collapse:collapse; margin:4px 0 16px 0;">
                        <tr>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        ['alamat_tujuan', 'kelurahan_tujuan', 'kecamatan_tujuan', 'kota_tujuan'].forEach(id => {
            document.getElementById(id)?.addEventListener('input', function() {
                setP('p-' + id.replace(/_/g, '-'), this.value);
            });
        });
        ...
        document.getElementById('btnSimpan').addEventListener('click', async function() {
            ...
            if (!confirm(`⚠️ Perhatian!\n\nSetelah disimpan, status warga:\n"${nama}"\nakan otomatis berubah menjadi PINDAH.\n\nLanjutkan?`)) return;
